            ...
            <Paper className="pl-20 pr-20 pt-20 mb-30" elevation={0}>
                <div className="d-flex justify-between">
                    <div>
                        ...
                        <Typography style={{fontWeight: 700}} className="mt-10" variant="h4">
                            Amon Bower
                        </Typography>
                    </div>
                    <div>
                ...
                <div className="d-flex mb-10 mt-10">
                    <Typography style={{fontWeight: 700, color: '#35ab66'}} className="mr-15">
                        +208
                    </Typography>
                    <Typography>2 подписчика</Typography>
                </div>
                <Typography>На проекте с 15 сентября 2016</Typography>
